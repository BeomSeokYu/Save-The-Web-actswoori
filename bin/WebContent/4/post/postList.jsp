...
%>
	...
	<tr><td><hr></td></tr>
	<tr><td><%=post.getPtitle() %></td></tr>
	<tr><td><%=post.getPupfolder() %></td></tr>
	<tr><td><%=post.getPuuid() %></td></tr>
	<tr><td><%=post.getPfilename() %></td></tr>
	<tr><td><iframe src="<%=post.getPupfolder() %>/<%=post.getPuuid() %>_<%=post.getPfilename() %>"></iframe></td></tr>

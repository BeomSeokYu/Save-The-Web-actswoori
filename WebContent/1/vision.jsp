				...
				<div class="col-lg-9">
					...
					<div class="album py-5">
   					...
   					<img src="vision.png" width="100%" height="300"style="margin-bottom:80px">
   					 ...
   					 <div class="container">
   					 <p style="font-weight:bold; font-size:20px; color:#267278;">행전우리교회는 복음으로 하나되어 예배 양육 전도하는 한몸공동체입니다.</p>
					...
					<p style="font-weight:bold; font-size:20px; color:#267278;">2023년 표어</p>
						<p> 다음 세대를 이어가는 믿음의 경주자(히12:1-3)</p><br><br>
						
					<p style="font-weight:bold; font-size:20px; color:#267278;">2023년 목표</p>
						<p>예배ㆍ양육ㆍ전도가 균형 잡힌 그리스도인</p><br><br>
					
					<p style="font-weight:bold; font-size:20px; color:#267278;">행전우리교회가 지향하는 교회상</p>

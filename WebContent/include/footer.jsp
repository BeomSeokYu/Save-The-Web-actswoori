...
<script type="text/javascript">
	...
	function popModalTwo(head, body) {
		$('#msgModalLabel').text(head);
		$('#msgModalBody').html(body);
		$('#modal-footer').empty()
			.append('<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">취소</button>'
					+ '<button type="button" class="btn btn-warning" data-bs-dismiss="modal" id="doneBtn">확인</button>')
		$('#msgModal').modal('show');
	}
</script>